 ...
 */
@Configuration
@ConditionalOnClass(name = "com.myhero.frame.core.factory.SqlSessionFactory")
...
public class HerobatisAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "myherobatis.frame.enable",havingValue = "true",matchIfMissing = true)
